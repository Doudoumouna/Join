...
function changeTaskTemplate(id) {
  return /*html*/ `
        <form onsubmit="saveChangedTask(${
          currentTask.id
        }); return false;" class="editTask">
            <img class="CloseCross-DetailTask pointer" onclick="hideAddTaskMask()" src="assets/img/group 11.png" alt="">
        
            <div class="input-title">
                <input id="changed_title" type="text" value="${
                  currentTask.title
            ...
            <div>
                <h4>Description</h4>
                <textarea class="add-description" id="changed_description" placeholder="Enter a Description">${currentTask.description.replace(
                  /<br\s*\/?>/gi,
                  ''
                )}</textarea>
            </div>
            ...
            <div class="input border-bottom" style="display:flex; flex-direction: column; align-items:flex-start;">
                ...
                <div class= "input-date" id="input-date">
                    <input id="add-date" class="add-date" value="${
                      currentTask.dueDate
                    }" type="date">
                </div>
            </div>
            ...
            <div class="task-edit-btns">
                <div onclick="deleteTask(${
                  currentTask.id
                })" class="btn trash-button"><img class="trash" src="assets/img/trash.ico" alt=""></div>
 ...
 */
function renderAssignedSubTasksTemplate(
  currentSubTask,
