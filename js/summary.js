...
function showNumberOfTasksUrgent() {
  let numberOfTasksUrgentContainer = document.getElementById(
    'number_of_tasks_urgent'
  );
...
function checkNextDueDate(dueDates) {
  ...
  if (dueDates.length > 0 && dueDates[0] != '') {
    ...
    let nextDueDate =
      month + ' ' + dueDate.getDate() + ', ' + dueDate.getFullYear();
...
function showNumberOfTasksToDo() {
  let numberOfTasksToDoContainer = document.getElementById(
    'number_of_tasks_todo'
  );
...
function showNumberOfTasksInProgress() {
  let numberOfTasksInProgressContainer = document.getElementById(
...
function showNumberOfTasksAwaitingFeedback() {
  let numberOfTasksAwaitingFeedbackContainer = document.getElementById(
    'number_of_tasks_awaiting_feedback'
  );
  ...
  numberOfTasksAwaitingFeedbackContainer.innerHTML =
    numberOfTasksAwaitingFeedback;
}
