  ...
  return /*html*/ `
        <div class="contact-detail-main-side animationFadeInRight" id="${index}">
            <div class="back-in-media-contact">
                <img onclick="closeMediaContact(${index})" src="./assets/img0/arrow-back.png" alt="">
            </div>
            <div class="contact-detail-head">
                ...
                <div class="contact-detail-name-task">
                    ...
                    <p class="contact-detail-add-task" onclick="OpenContactAddTask('0', ${index})"><img src="./assets/img0/blue-plus.png" alt="">Add Task</p>
                </div>
            </div>
