...
function checkUserData(userEmail, userPassword) {
  ...
  let indexOfPassword = users.findIndex(
...
function guestLogin() {
  ...
  checkUserData('noreply@nix.de', 'INFO');
  console.log('end');
}
...
async function resetPassword() {
  ...
  if (timeout < 1440) {
    ...
    let resetPasswordContainer = document.getElementById(
...
async function saveNewPassword(checkMail) {
  ...
  let newPasswordConfirm = document.getElementById(
...
function passwordConfirmIconChange() {
  let userPasswordConfirmInput = document.getElementById(
    'new_password_confirm'
  );
  let passwordConfirmIcon = document.getElementById(
    'user_password_confirm_icon'
  );
  let passwordConfirmIconHidden = document.getElementById(
    'user_password_confirm_hidden'
  );
...
function makePasswordConfirmVisible() {
  ...
  let passwordConfirmIconVisible = document.getElementById(
    'user_password_confirm_visible'
  );
  let userPasswordConfirmInput = document.getElementById(
    'new_password_confirm'
  );
