...
function checkEmailInArray(contactTask) {
  ...
  for (i = 0; i < currentUser.contacts.length; i++) {
    if (
      currentUser.contacts[i]['contactEmail'].toLowerCase() ==
      email.toLowerCase()
    ) {
...
function openDetailContact(index, lettersFB) {
  ...
  if (contactMedia.matches) {
    ...
    document
      .getElementById('contact-detail-in-main')
      .classList.remove('display-contact-none');
  }
  let contactdetailsinmedia = document.getElementById('contact-detail-in-main');
  contactdetailsinmedia.innerHTML = '';
  contactdetailsinmedia.innerHTML = contactDetailHtml(
    contact,
    lettersFB,
    index
  );
...
function closeMediaContact(index) {
  ...
  document
    .getElementById('contact-detail-in-main')
    .classList.add('display-contact-none');
  document
    .getElementById('contactbar')
    .classList.remove('display-contact-none');
}
